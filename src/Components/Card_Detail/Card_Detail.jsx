...
//     "http://www.banarasee.in/cdn/shop/files/IMG_0580_c1c2a33b-2e91-432a-97a4-b457ec4688bd.jpg",
...
//     "https://www.banarasee.in/cdn/shop/files/IMG_5555_1400x.jpg?v=1756455721",
//   ];
...
//           <div className="hidden md:flex flex-col gap-3 w-20 items-center">
//             {thumbnails.map((t, i) => (
//               <button
//                 key={i}
//                 onClick={() => setMainImage(t)}
//                 className={`w-16 h-16 p-1 border rounded overflow-hidden transition-shadow ${mainImage === t ? 'ring-2 ring-orange-500' : 'ring-0'}`}
//               >
//                 <img src={t} alt={`thumb-${i}`} className="object-cover w-full h-full" />
//               </button>
//             ))}
//           </div>

//           <div className="flex-1">
//             <div className="relative bg-gray-50 rounded shadow-sm overflow-hidden">
//               <img src={mainImage} alt="main" className="w-full h-[80vh] md:h-[145vh] object-cover" />
//               <div className="absolute left-4 bottom-4 bg-white/80 text-sm rounded-full px-4 py-2 shadow-md">
...
//               {thumbnails.map((t, i) => (
//                 <button key={i} onClick={() => setMainImage(t)} className={`flex-none w-20 h-32 p-1 border rounded ${mainImage === t ? 'ring-2 ring-orange-500' : ''}`}>
//                   <img src={t} alt={`thumb-sm-${i}`} className="object-cover w-full h-full" />
//                 </button>
//               ))}
//             </div>
//           </div>
...
//           <h1 className="text-2xl md:text-3xl font-serif font-semibold">Banarasee Handloom Satin Hand Dyed Saree With Mirror Work - Blush Pink & Yellow</h1>
//           <div className="text-sm text-gray-500">SKU: BAAP3419</div>

//           <div className="mt-2 text-2xl font-bold">₹ 2,499.00</div>
...
//                 <option>Blush Pink & Yellow</option>
//                 <option>Peach & Cream</option>
//                 <option>Gold & Maroon</option>
//               </select>
//             </div>

//             <div>
//               <label className="block text-sm font-medium mb-1">Size</label>
//               <select className="w-full border p-3 rounded" value={size} onChange={(e) => setSize(e.target.value)}>
//                 <option>Saree:length 6.3M (including blouse piece)</option>
//                 <option>Custom Stitching Available</option>
//                 <option>Child Size</option>
//               </select>
//             </div>

//             <div>
//               <label className="block text-sm font-medium mb-1">Material</label>
//               <select className="w-full border p-3 rounded" value={material} onChange={(e) => setMaterial(e.target.value)}>
//                 <option>Satin</option>
//                 <option>Silk</option>
...
//             <div className="text-sm font-medium mb-2">Customization Options (Only Available for Prepaid Orders)</div>
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
//               {Object.keys(customizations).map((key) => (
//                 <label key={key} className="flex items-center gap-2 text-sm">
//                   <input type="checkbox" checked={customizations[key]} onChange={() => toggleCustomization(key)} />
...
//             <button className="flex-1 bg-yellow-400 hover:bg-yellow-500 text-black py-3 rounded font-medium">Add to Cart</button>
//             <button className="flex-1 bg-green-600 hover:bg-green-700 text-white py-3 rounded font-medium">Buy It Now</button>
//             <button className="flex-none border px-4 py-3 rounded flex items-center gap-2">❤️ Add to Wishlist</button>
//           </div>

//           <div className="mt-4 space-y-2">
//             <Accordion title="Product Details" open={accordionOpen.productDetails} onToggle={() => toggleAccordion('productDetails')}>
//               <p className="text-sm text-gray-700">This saree is handloom satin, hand-dyed with mirror work. Length: 6.3M including blouse piece. Care: Dry clean only.</p>
//             </Accordion>

//             <Accordion title="Return Policy" open={accordionOpen.returnPolicy} onToggle={() => toggleAccordion('returnPolicy')}>
//               <p className="text-sm text-gray-700">Returns accepted within 7 days in original condition. Customizations are non-refundable.</p>
//             </Accordion>

//             <Accordion title="Additional Information" open={accordionOpen.additionalInfo} onToggle={() => toggleAccordion('additionalInfo')}>
//               <p className="text-sm text-gray-700">Dispatch within 2-4 business days. Free shipping on orders above ₹499.</p>
//             </Accordion>
//           </div>
//         </div>
//       </div>
...
//     <div className="w-9 h-9 bg-gray-100 rounded flex items-center justify-center text-sm font-medium">{iconLabel[0]}</div>
...
//     </button>
//     <div className={`px-4 pb-4 transition-all ${open ? 'block' : 'hidden'}`}>{children}</div>
//   </div>
// );
...
//       <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2   gap-8">
//         {/* LEFT SECTION */}
//         <div className="flex flex-col sticky top-4 self-start  md:flex-row overflow-auto md:items-start gap-4">
//           <div className="hidden md:flex flex-col gap-3 w-20 items-center">
//             {thumbnails.map((t, i) => (
//               <button
//                 key={i}
...
//         {/* LEFT SECTION */}
//         <div className="flex flex-col items-center sticky top-4 self-star overflow-auto">
//           {/* Main Image */}
//           <div className="relative bg-gray-50 rounded shadow-sm overflow-hidden w-full">
//             <img
//               src={mainImage}
//               alt="main"
//               className="w-full h-[60vh] sm:h-[70vh] md:h-[80vh] object-cover rounded"
//             />
...
//           {/* Thumbnails */}
//           <div className="mt-4 flex gap-2 overflow-x-auto w-full justify-start md:justify-center">
//             {thumbnails.map((t, i) => (
//               <button
//                 key={i}
//                 onClick={() => setMainImage(t)}
//                 className={`flex-none w-20 h-24 sm:w-24 sm:h-28 border rounded overflow-hidden transition-all duration-300 ${
...
//   {/* Main Image (Right side on large screens) */}
//   <div className="relative bg-gray-50 rounded shadow-sm overflow-hidden w-full">
//     <img
//       src={mainImage}
//       alt="main"
